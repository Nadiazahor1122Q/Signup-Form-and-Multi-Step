...
const validationSchema = Yup.object({
  ...
  age: Yup.number().required("Required").moreThan(15, "Age Must br Greater than 15").lessThan(70, "Age Must br Less than 15"),
  phoneNumber: Yup.string().required("Required").min(10, "Minimum of 11 numbers").max(13, "Maximum of 11 numbers"),
});
